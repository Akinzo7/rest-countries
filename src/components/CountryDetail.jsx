...
const CountryDetail = ({ countries }) => {
  ...
  return (
    <div className="mt-13 px-15">
      <button
        className="flex items-center justify-center bg-[hsl(209,23%,22%)] py-2 px-8 shadow-lg gap-2 rounded-sm text-[12px]"
        type="button"
        onClick={() => navigate(-1)}
      >
        <HiArrowNarrowLeft />
      ...
      <div className="my-14 grid grid-cols-1 md:grid-cols-2 gap">
        <div className="border-20 max-w-[600px] h-[400px] border-[hsla(208,23%,13%,0.2)] rounded-lg  overflow-hidden">
          <img
        ...
        <div className="flex flex-col justify-center gap">
          <h3 className="font-extrabold text-2xl">{country.name}</h3>
